...
public class Board {	
	...
	public Board(Tile tile1, Tile tile2, Tile tile3, Tile tile4, Tile tile5, Tile tile6, Tile tile7, Tile tile8, Tile tile9, Tile tile10, Tile tile11, Tile tile12) {
		Tile board[] = new Tile[12];
		board[0] = this.tile1;
		board[1] = this.tile2;
		board[2] = this.tile3;
		board[3] = this.tile4;
